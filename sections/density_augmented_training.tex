...
\end{equation}
The configuration $(\gamma_t,\psi_t)$ may be random or generated from a geometry- or physics-based refinement rule. We use the point-to-slice correction from Eq.~\eqref{eq:unified_refinement_correction} during the forward pass and optimize
\begin{equation}
