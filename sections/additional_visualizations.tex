...
On Airfoil, CA at a $75\%$ budget reaches a normalized pressure error of
$1.025$, using $25\%$ fewer points than the shared backbone's full mesh.
...
\begin{figure}[!ht]
    ...
    used by AdaSolver. Insets enlarge crowded portions of the mean curves.}
...
relative to Uniform. CA gives the lowest error for this geometry ($1.30\%$),
with PI and CPG attaining $1.33\%$ and $1.35\%$, respectively.
